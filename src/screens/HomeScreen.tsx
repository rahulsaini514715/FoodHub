  ...
  const products = [
    {
      ...
      price: 80,
      imageUrl:
        'https://aumswow.com/life-veda/assets/images/ingredients/milk-indian-buffalo.jpg',
    },
    {
      id: '2',
      name: 'Cow Milk',
      price: 60,
      imageUrl:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSKY3p91VuBdAdTnifDQ-bg0sB7H50zHDrW3g&s',
    },
    {
      id: '3',
      name: 'Curd',
      price: 45,
      imageUrl:
        'https://images.apollo247.in/pd-cms/cms/2025-02/Curd%20Benefits%20(1).jpg?tr=q-80,f-webp,w-400,dpr-2.5,c-at_max%201000w',
    },
    {
      id: '4',
      name: 'Butter',
      price: 55,
      imageUrl:
        'https://m.media-amazon.com/images/I/717GgfVk6YL._AC_UF894,1000_QL80_.jpg',
    },
    {
      id: '5',
      name: 'Ghee',
      price: 520,
      imageUrl:
        'https://www.eatingwell.com/thmb/EY63AWae1w0ru7GZQBhYf5zoug8=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/what-is-ghee-b7d45427a4064055a4b3d920cf6c22a1.jpg',
    },
  ];
        ...
        <View className="p-4">
          ...
          >
            {products?.map(p => (
              <View
                key={p.id}
                className="w-64 mr-4 bg-white rounded-xl overflow-hidden"
              >
